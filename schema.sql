...
-- Cold-outreach email tracking. First-party open/click/unsubscribe tracking for
-- vendor outreach, surfaced in /admin. Sending stays in Gmail; the Worker only
-- registers each send and serves the /t/ endpoints. See migration 0008.

-- Leads: vendors we reach out to. Email is unique so re-adding dedupes.
